    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="projects" className={`${this.props.article === 'projects' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p><a href='https://thescheduler.netlify.com/'>Scheduler</a> is a React client side app with an express backed that allows employers to post schedules or important news to their employees. The individuals modifying the schedules can use an access key(1234) to update it and change it as needed. The employees who just get to see the uploaded forms and assigned the key (1111).</p>
